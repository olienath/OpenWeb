...
const contractABI = require("../artifacts/contracts/Openwebuiadmin.sol/Openwebuiadmin.json").abi;

program
    .name("openwebuiadmin-cli")
    .description("CLI tool for Openwebuiadmin smart contract")
    .version("1.0.0");
