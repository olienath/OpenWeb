 ...
 * This file demonstrates how to integrate Openwebuiadmin with a web frontend
 */

// For React/Vue/Angular applications
export class OpenwebuiadminClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OpenwebuiadminClient(provider, contractAddress);
